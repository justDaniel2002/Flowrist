...
export default function StaffSideBar() {
  ...
  return (
    ...
    <div className=" rounded-lg pt-5 min-h-screen bg-green-100 px-1">
     <div className="flex items-center my-20">
      ...
      {sideBarStaffData.map((data) => (
        <div onClick={() => navigate(data.link)} className={`w-full rounded-xl py-2 px-5 mb-1 ${location.pathname==data.link?"bg-green-300":"bg-green-200"}`}>
