  ...
  return (
    <div className="bg-green-100 px-10 py-10">
      ...
      <div className="border border-black">
        <div className="px-5 pt-10 text-xl font-medium bg-green-200 ">
          <div className="mb-10">
        ...
        <div className="bg-white p-5">
            <div className="text-green-100 mb-2">Nội dung bài viết</div>
        </div>
        <div className="bg-white p-5">
            <div className="text-green-100 mb-2">Hình ảnh đính kèm</div>

            <div className="flex justify-end text-green-100 bg-green-300 p-3 rounded-full"><Icon icon="material-symbols:edit" /></div>
        </div>
      </div>
