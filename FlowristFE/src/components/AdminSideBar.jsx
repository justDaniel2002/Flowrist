...
export default function AdminSideBar() {
  ...
  return (
    <div className=" min-h-screen ">
      <div className="border-r border-neutral-200 rounded-lg pt-5 min-h-screen bg-green-100 px-1">
       <div className="flex items-center my-20">
        ...
        {sideBarAdminData.map((data) => (
          <div onClick={() => navigate(data.link)} className={`w-full flex items-center rounded-xl py-1 px-5 mb-1 ${location.pathname==data.link?"bg-green-300":"bg-green-200"}`}>
